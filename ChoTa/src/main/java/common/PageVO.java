...
public class PageVO {
	...
	private int curBlock;	//현재 보여질 블럭번호
	...
	public void setTotalList(int totalList) {
		...
		//총 블럭갯수: 총 페이지갯수/한 블럭당 보여질 페이지 갯수
		//90/10 - 9...0 -> 9블럭
		...
		//1페이지: 898, 2페이: 888, 3페이지: 878
		endList = totalList - (curPage-1)*pageList;
		//시작 글번호: 끝 글번호 - (페이지당 보여질 글 건수-1)
		...
		//현재블럭에 따라 보여질 시작/끝 페이지번호가 결정
		//끝 페이지번호: 현재 블럭번호 * 블럭당 보여질 페이지수
		// 1블럭 : 1~10, 2블럭 : 11~20, 3블럭 : 21~30, 
		endPage = curBlock * blockPage;
		//시작 페이지번호: 끝페이지번호 - (블럭당 보여질 페이지수 - 1)
		beginPage = endPage - (blockPage-1);
		
		//90페이지: 1~10, 11~20, 21~30, 31~40, 41~50, 51~60, 61~70, 71~80, 81~90
